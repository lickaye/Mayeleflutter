...
class SliderEntreprenariatPage extends StatefulWidget {

  const SliderEntreprenariatPage({Key? key}) : super(key: key);

  @override
  _SliderEntreprenariatPageState   createState() => _SliderEntreprenariatPageState();

}

class _SliderEntreprenariatPageState extends  State<SliderEntreprenariatPage>{
  List contenu = [];
  ...
  fetchContenu() async {
    ...
    if (response.statusCode == 200) {
      var items = json.decode(response.body)['Contenu']['Entreprenariat'];
      setState(() {
        contenu = items;
        isLoadibg=true;
      });
