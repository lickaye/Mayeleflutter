...
class pubOnePage extends StatefulWidget {
  const pubOnePage({Key? key}) : super(key: key);

  @override
  _pubOnePageState createState() => _pubOnePageState();
}

class _pubOnePageState extends State<pubOnePage> {
  List contenu = [];
  ...
  fetchContenu() async {
    ...
    if (response.statusCode == 200) {
      var items = json.decode(response.body)['Publicite']['pubOne'];
      setState(() {
        contenu = items;
        isLoadibg = true;
      });
